...
<div class="d-flex justify-content-between align-items-center">
    ...
    <div>
        ...
        <button class="btn btn-primary mr-2" data-toggle="modal" data-target="#tambahPengumumanModal">Tambah Kategori</button>
    </div>
</div>
<hr>
                  ...
                  <tbody>
                    ...
                    <td>
                      <span class="icon-frame">
                        ...
                        <button data-target="#editKategori" data-toggle="modal" style="border: none">
                    ...
                    <div class="modal fade" id="editKategori" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              @include ('admin.modal.kategoriEdit')
                            </div>
                          </div>
                        </div>
                    </div>                 
