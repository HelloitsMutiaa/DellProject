                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Peraturan Perpustakaan Tahun 2023</td>
                      <td>
                    ...
                    <tr>
                      <td>PPITDEL/13/09/23/01</td>
                      <td>Peraturan Perpustakaan Tahun 2013</td>
                      <td>
                      <span class="icon-frame">
                      <button style="background-color: #6C757D; color: white; border: none; padding: 5px 10px; cursor: pointer;">
                        Gunakan
                    ...
                    <tr>
                      <td>PPITDEL/13/09/23/01</td>
                      <td>Peraturan Perpustakaan Tahun 2011</td>
                      <td>
                      <span class="icon-frame">
                      <button style="background-color: #6C757D; color: white; border: none; padding: 5px 10px; cursor: pointer;">
                        Gunakan
                    ...
                    <tr>
                      <td>PPITDEL/13/09/23/01</td>
                      <td>Peraturan Perpustakaan Tahun 2019</td>
                      <td>
                      <span class="icon-frame">
                      <button style="background-color: #6C757D; color: white; border: none; padding: 5px 10px; cursor: pointer;">
                        Gunakan
                    ...
                    <tr>
                      <td>PPITDEL/13/09/23/01</td>
                      <td>Peraturan Perpustakaan Tahun 2020</td>
                      <td>
                      <span class="icon-frame">
                      <button style="background-color: #6C757D; color: white; border: none; padding: 5px 10px; cursor: pointer;">
                        Gunakan
